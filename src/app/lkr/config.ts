export const LkrConfig = {
    container: "w-full min-h-screen p-3 sm:p-4 md:p-6 bg-white flex flex-col gap-4 sm:gap-6",
    
    header: {
        container: "w-full flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-6 px-0",
        logo: {
        ...
        buttonIcons: {
            menu: [
                ...
                {
                    id: 2,
                    icon: "/icon/header-menu/standard/services.svg",
                    text: "Сервисы",
                    href: "/"
                },
        ...
        profile: {
            container: "flex items-center gap-3 sm:gap-4 relative mt-3 md:mt-0"
        }
    },
        ...
        rightColumn: {
            ...
            topRow: {
                ...
                card: {
                    ...
                    content: {
                        container: "flex-1 bg-blue-50 rounded-lg sm:rounded-xl flex flex-col justify-between",
                        title: "text-black text-sm sm:text-base",
